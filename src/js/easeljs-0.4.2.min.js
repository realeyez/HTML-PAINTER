    ...
    if(!(this._frames||this._frameWidth==0)){
        ...
        for(var b=0,a=this._frameWidth,c=this._frameHeight,e=0,d=this._images;e<d.length;e++){
            for(var f=d[e],g=(f.width+1)/a|0,k=(f.height+1)/c|0,k=this._numFrames>0?Math.min(this._numFrames-b,g*k):g*k,i=0;i<k;i++)this._frames.push({
                image:f,
                rect:new Rectangle(i%g*a,(i/g|0)*c,a,c),
                regX:this._regX,
                regY:this._regY
                });
            b+=k
...
a.swapChildren=function(b,a){
    for(var c=this.children,e,d,f=0,g=c.length;f<g;f++)if(c[f]==b&&(e=f),c[f]==a&&(d=f),e!=null&&d!=null)break;f!=g&&(c[e]=a,c[d]=b)
    };
    
a.setChildIndex=function(b,a){
    for(var c=this.children,e=0,d=c.length;e<d;e++)if(c[e]==b)break;e==d||a<0||a>d||e==a||(c.splice(a,1),a<e&&e--,c.splice(b,e,0))
    };
...
a._getObjectsUnderPoint=function(b,a,h,e){
    ...
    for(var i=this.children.length-1;i>=0;i--){
        ...
        if(l.isVisible()&&l.mouseEnabled)if(l instanceof c)if(k){
            ...
            this._testHit(d))if(f.width=0,f.width=1,k)return this;
            else if(h)h.push(l);else return l
            }
            return null
    };
...
(function(j){
    ...
    a.draw=function(b,a){
        ...
        for(var c=String(this.text).split(/(?:\r\n|\r|\n)/),e=this.lineHeight==null?this.getMeasuredLineHeight():this.lineHeight,d=0,f=0,g=c.length;f<g;f++){
            ...
            if(this.lineWidth==null||k<this.lineWidth)this._drawTextLine(b,c[f],d);
            else{
